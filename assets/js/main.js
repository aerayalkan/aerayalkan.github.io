(function () {
  ...
  const translations = {
    en: {
      ...
      "about.p3": 'I hold esteemed certifications including <strong>Oracle Java Development</strong>, <strong>Google Cloud Data Analytics</strong>, <strong>Google Cybersecurity Specialization</strong>, and <strong>Google Generative AI for Developers</strong>. I have also earned multiple <strong>AWS Educate</strong> badges covering <strong>Machine Learning Foundations</strong>, <strong>Introduction to Generative AI</strong>, <strong>Introduction to Cloud 101</strong>, and <strong>Getting Started with Storage</strong>. My graduate project, <strong>TrustVault</strong>, focused on <strong>AI-Powered Fraud Detection</strong> — combining machine learning and blockchain technology to identify and prevent fraudulent credit card activities with 95%+ accuracy.',
    ...
    tr: {
      ...
      "about.p3": '<strong>Oracle Java Development</strong>, <strong>Google Cloud Data Analytics</strong>, <strong>Google Cybersecurity Specialization</strong> ve <strong>Google Generative AI for Developers</strong> gibi prestijli sertifikalara sahibim. Ayn\u0131 zamanda <strong>AWS Educate</strong> program\u0131 kapsam\u0131nda <strong>Makine \u00d6\u011frenimi Temelleri</strong>, <strong>Generative AI&apos;ya Giri\u015f</strong>, <strong>Bulut Bili\u015fime Giri\u015f 101</strong> ve <strong>Depolama ile Ba\u015flang\u0131\u00e7</strong> rozet sertifikalar\u0131na sahibim. Bitirme projem <strong>TrustVault</strong>, makine \u00f6\u011frenimi ve blok zinciri teknolojisini birle\u015ftirerek kredi kart\u0131 sahtecili\u011fini %95+ do\u011frulukla tespit eden <strong>Yapay Zeka Destekli Doland\u0131r\u0131c\u0131l\u0131k Tespiti</strong> sistemi \u00fczerine odaklanm\u0131\u015ft\u0131r.',
